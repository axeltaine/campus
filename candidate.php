...
<body>
  ...
  <div class="global">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-5 col-lg-5">
          <!-- pour grands et moyen: 3 lignes, tablette 2l et smart 3l-->
          ...
          <div class="form-group">
            <!-- case pour l'objet-->
            <input type="text" class="form-control" placeholder="Objet *" id="objet" required
              data-validation-required-message="Please enter your object.">
            <p class="help-block text-danger"></p>
          </div>
        </div>
        <!--fin col-->
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
          <div class="map-responsive">
            <!-- maps-->
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2578.510620049108!2d4.719754465705761!3d49.738835379383545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47ea121fdd612bdb%3A0x89076a33c9920d1e!2sMoulin+Leblanc!5e0!3m2!1sfr!2sfr!4v1555413749362!5m2!1sfr!2sfr"
    ...
    <div class="row">
      ...
      <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1"><a href="#"><i class="fas fa-chevron-up fa-2x" id="top"></i></a>
      </div>
    </div>
  </div>
